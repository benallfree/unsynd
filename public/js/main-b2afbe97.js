    ...
    3: [
      function(require, module, exports) {
          ...
          exports.default = {
            ...
            mounted: function mounted() {
              ...
              var updateTime = function updateTime() {
                ...
                _this.$data.currentTime = moment
                  .duration(_this.$data.player.getCurrentTime(), 'seconds')
                  .format(f, { trim: false })
                _this.$data.duration = moment
                  .duration(_this.$data.player.getDuration(), 'seconds')
                  .format(f, { trim: false })
              }
        ...
        __vue__options__.render = function render() {
          ...
          return _c('div', { staticClass: 'wavesurfer clearfix' }, [
            _c('div', { staticClass: 'wavesurfer-player' }, [
              _c('div', { staticClass: 'wavesurfer-player-left' }, [
                _vm._v(_vm._s(_vm.currentTime))
              ]),
              _c('div', { staticClass: 'wavesurfer-player-right' }, [
                _vm._v(_vm._s(_vm.duration))
              ]),
              _c('div', {
                ref: 'player',
                staticClass: 'wavesurfer-player-center'
              })
            ]),
            _c('div', { staticClass: 'wavesurfer-controls' }, [
              _vm._m(0),
              _vm._m(1),
              _c('button', { staticClass: 'btn btn-xs btn-primary' }, [
                ...
                _vm.is_playing
                  ? _c('i', {
                      staticClass: 'fa fa-pause-circle',
                      on: { click: _vm.pause }
                    })
                  : _vm._e()
              ]),
              _vm._m(2),
              _vm._m(3),
              _c('div', { staticClass: 'wavesurfer-console' }, [
        ...
        __vue__options__.staticRenderFns = [
          function render() {
            ...
            var _h = _vm.$createElement
            var _c = _vm._self._c || _h
            return _c('button', { staticClass: 'btn btn-xs btn-primary' }, [
              _c('i', { staticClass: 'fa fa fa-step-backward' })
            ])
          },
          function render() {
            var _vm = this
